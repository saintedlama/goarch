...
// IsExported returns a filtered collection containing only exported variables and constants
...
// IsUnexported returns a filtered collection containing only unexported variables and constants
